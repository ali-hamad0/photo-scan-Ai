...
cb1 = [
    ...
    ReduceLROnPlateau(factor=0.5, patience=3, min_lr=1e-7, monitor='val_accuracy', mode='max', verbose=1),
    ModelCheckpoint(SAVE_PATH, save_best_only=True, monitor='val_accuracy', mode='max', verbose=1)
]
...
cb2 = [
    ...
    ReduceLROnPlateau(factor=0.3, patience=4, min_lr=1e-8, monitor='val_accuracy', mode='max', verbose=1),
    ModelCheckpoint(SAVE_PATH, save_best_only=True, monitor='val_accuracy', mode='max', verbose=1)
]
