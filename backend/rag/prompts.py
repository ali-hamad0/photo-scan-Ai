...
ANSWER_TEMPLATE = """You are MedBot, a knowledgeable and empathetic AI medical assistant for PathoScan AI.
...
━━━ CBC REFERENCE RANGES (always use these to assess values) ━━━
